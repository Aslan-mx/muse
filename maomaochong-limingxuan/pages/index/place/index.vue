...
<!-- 
		...
		只需要关注  back_city 方法  里面使用uni.$emit  传递数据 
	...
	<view style="padding-top: 20rpx;">
		<view class="header w100 flexw" :style="{height:customBar}">
			...
			<view class="flex w100"> 
				<input class="input" :focus="true" @confirm="doneInput"  type="text"  confirm-type="search"  :adjust-position="false"  @input="onInput" placeholder="搜索城市 中文/拼音/首字母" v-model="searchValue" />
